...
**สอน CPU 30 ชิปตัวนี้ทีละขั้น ใช้ภาษาง่ายๆ ไม่รีบ อ่านจบแล้วต่อวงจรได้เลย**
...
ทั้งหมดนี้ทำได้ด้วยชิป 30 ตัว ไม่มี microcode ไม่มี lookup table.
...
CPU 30 ชิปอยู่บน breadboard — แต่ต้องต่อกับ:
...
- **สัญญาณเหมือนกัน! แค่ CPU ข้างในเป็น 30 ชิปแทน 1 ชิป**
