...
def MEM_AT28C256(name: str) -> Chip:
...
def create_cpu():
    ...
    # PC (U1-U4): 74HC161 ×4
    chips['U1'] = TTL_74hc161('U1')
    chips['U2'] = TTL_74hc161('U2')
    chips['U3'] = TTL_74hc161('U3')
    chips['U4'] = TTL_74hc161('U4')

    # IR + AC + Page Reg + Data Page (U5,U6,U9,U23,U32): 74HC574 ×5
    chips['U5'] = TTL_74hc574('U5')
    chips['U6'] = TTL_74hc574('U6')
    chips['U9'] = TTL_74hc574('U9')
    chips['U23'] = TTL_74hc574('U23')
    chips['U32'] = TTL_74hc574('U32')

    # Bus buffer (U7): 74HC245
    chips['U7'] = TTL_74hc245('U7')

    # Ring counter (U8): 74HC164
    chips['U8'] = TTL_74hc164('U8')

    # Adder (U10,U11): 74HC283 ×2
    chips['U10'] = TTL_74hc283('U10')
    chips['U11'] = TTL_74hc283('U11')

    # XOR (U12,U13,U28): 74HC86 ×3
    chips['U12'] = TTL_74hc86('U12')
    chips['U13'] = TTL_74hc86('U13')
    ...
    for i in range(15, 21):
        chips[f'U{i}'] = TTL_74hc157(f'U{i}')
    chips['U29'] = TTL_74hc157('U29')
    chips['U30'] = TTL_74hc157('U30')

    # Z flag + IRQ (U21, U31): 74HC74 ×2
    chips['U21'] = TTL_74hc74('U21')
    chips['U31'] = TTL_74hc74('U31')

    # Zero detect (U22): 74HC688
    chips['U22'] = TTL_74hc688('U22')

    # Inverters (U24): 74HC04
    chips['U24'] = TTL_74hc04('U24')

    # OR gates (U25): 74HC32
    chips['U25'] = TTL_74hc32('U25')

    # NAND gates (U26, U27): 74HC00 ×2
    chips['U26'] = TTL_74hc00('U26')
    chips['U27'] = TTL_74hc00('U27')

    # SETDP decode (U33): 74HC21
    chips['U33'] = TTL_74hc21('U33')

    # Memory
    chips['ROM'] = MEM_AT28C256('ROM')
    chips['RAM'] = MEM_62256('RAM')
