"""
RV8-GR Full CPU Simulation — runs programs through 34 logic chips plus ROM/RAM.
...
class CPUSim:
        ...
        for iteration in range(3):
            ...
            for entry in WIRING:
                if len(entry) == 4:
                    ...
                    # Skip ROM/RAM /WE and ROM/RAM data pins — handled by step() logic
    ...
    def step(self):
        ...
        if self.phase == 0:  # T0: latch control byte
            ...
            # Page Register: physical U23 clock ignores XOR/SUB/JMP/BR bits.
            if s['MUX'] and not s['AC_WR']:
                self.page_reg = ibus
