...
module tb_rv8gr;
    ...
    initial begin
        ...
        // ROM at $0000-$7FFF → rom[addr[14:0]]
        // RAM at $8000-$FFFF → ram[addr[14:0]]

        // === Page $00 ($0000+) — Main test (PC starts here) ===
        ...
        // Jump to page $10 (ROM: $1000)
        cpu.rom[15'h0038] = 8'h20; cpu.rom[15'h0039] = 8'h10; // SETPG $10
        cpu.rom[15'h003A] = 8'h01; cpu.rom[15'h003B] = 8'h00; // J $00 → $1000

        // === Page $10 ($1000, ROM offset $1000) ===
        cpu.rom[15'h1000] = 8'h20; cpu.rom[15'h1001] = 8'h7F; // SETPG $7F
        cpu.rom[15'h1002] = 8'h01; cpu.rom[15'h1003] = 8'h00; // J $00 → $7F00

        // === Page $7F ($7F00, ROM offset $7F00) ===
        cpu.rom[15'h7F00] = 8'h20; cpu.rom[15'h7F01] = 8'h00; // SETPG $00
        cpu.rom[15'h7F02] = 8'h01; cpu.rom[15'h7F03] = 8'h40; // J $40 → $0040

        // === Back at $0040 — subroutine test ===
        ...
        cpu.rom[15'h0046] = 8'h20; cpu.rom[15'h0047] = 8'h00; // SETPG $00
        ...
        cpu.rom[15'h0074] = 8'h20; cpu.rom[15'h0075] = 8'h00; // SETPG $00
        ...
        // Check result
        if (cpu.pc == 16'h0066 || cpu.pc == 16'h0067) begin
