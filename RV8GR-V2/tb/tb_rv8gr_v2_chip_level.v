// RV8GR-V2 generated chip-level netlist bring-up test.
`timescale 1ns/1ps

module tb_rv8gr_v2_chip_level;
  reg clk;
  reg rst_n;
  reg irq_n;
  integer cycle;
  ...
  initial begin
    ...
    $dumpfile("rv8gr_v2_chip_level.vcd");
    $dumpvars(0, tb_rv8gr_v2_chip_level);
    ...
    $display("RV8GR-V2 chip-level bring-up PASS: pc=%h phase=%b", pc, phase);
    $finish;
  end
endmodule
