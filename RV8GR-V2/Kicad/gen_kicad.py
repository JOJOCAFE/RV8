#!/usr/bin/env python3
"""
KiCad 10.0 Project Generator for RV8GR-V2 CPU
Generates complete schematic with 35 chips across 6 hierarchical sheets.
Generates KiCad netlist file (.net) with all 152 nets and pin connections.
...
NETLIST = {
    ...
    "VCC": [
        ...
        ("U29",16),("U30",16),("U31",14),("U32",20),("U33",14),
        ("ROM1",28),("RAM1",28),
        # Additional VCC ties
        ("U21",1),("U21",10),("U21",13),
        ("U28",5),("U28",10),("U28",13),
    ...
    "GND": [
        ...
        ("U29",8),("U30",8),("U31",7),("U32",10),("U33",7),
        ("ROM1",14),("RAM1",14),
        # Additional GND ties
        ("U5",1),("U9",1),("U23",1),("U32",1),
    ...
    "T2": [("U8",5),("U26",1),("U26",9),("U26",12),("U27",12),("U28",4),("U33",1),("U33",9)],
    "NOT_T0": [("U24",2),("U8",1)],
    "NOT_T1": [("U24",4),("U8",2)],
    ...
    # IRL outputs (U6 -> PC load, address mux, IBUS)
    "IRL0": [("U6",19),("U15",3),("U1",3)],
    "IRL1": [("U6",18),("U15",6),("U1",4)],
    "IRL2": [("U6",17),("U15",10),("U1",5)],
    "IRL3": [("U6",16),("U15",13),("U1",6)],
    "IRL4": [("U6",15),("U16",3),("U2",3)],
    "IRL5": [("U6",14),("U16",6),("U2",4)],
    "IRL6": [("U6",13),("U16",10),("U2",5)],
    "IRL7": [("U6",12),("U16",13),("U2",6)],
    ...
    # IBUS (internal bus)
    "IBUS0": [("U7",2),("U14",18),("U12",1),("U5",2),("U6",2),("U23",2),("U32",2)],
    "IBUS1": [("U7",3),("U14",17),("U12",4),("U5",3),("U6",3),("U23",3),("U32",3)],
    "IBUS2": [("U7",4),("U14",16),("U12",9),("U5",4),("U6",4),("U23",4),("U32",4)],
    "IBUS3": [("U7",5),("U14",15),("U12",12),("U5",5),("U6",5),("U23",5),("U32",5)],
    "IBUS4": [("U7",6),("U14",14),("U13",1),("U5",6),("U6",6),("U23",6),("U32",6)],
    "IBUS5": [("U7",7),("U14",13),("U13",4),("U5",7),("U6",7),("U23",7),("U32",7)],
    "IBUS6": [("U7",8),("U14",12),("U13",9),("U5",8),("U6",8),("U23",8),("U32",8)],
    "IBUS7": [("U7",9),("U14",11),("U13",12),("U5",9),("U6",9),("U23",9),("U32",9)],
...
def generate_netlist():
    ...
    lines.append('  (design')
    lines.append(f'    (source "RV8GR-V2.kicad_sch")')
...
def sch_header(title):
    return f'''(kicad_sch (version {KICAD_VERSION}) (generator "RV8GR-V2-gen")
  (uuid {uid()})
  (paper "A4")
  (title_block
    (title "RV8GR-V2 - {title}")
    (rev "v2.0")
    (company "RV8 Project")
    (comment 1 "33 logic chips + ROM + RAM = 35 packages")
  )
'''
...
'''
    derived_signals = ["ADDR_MODE", "/ADDR_MODE", "PC_INC", "/PC_LD",
...
if __name__ == "__main__":
    print("=" * 60)
    print("RV8GR-V2 KiCad Generator")
    print("=" * 60)

    # Create project file
    pro_path = os.path.join(OUTDIR, "RV8GR-V2.kicad_pro")
    with open(pro_path, "w") as f:
        f.write(generate_project())
    print(f"✓ Created RV8GR-V2.kicad_pro")

    # Create top-level schematic
    sch_path = os.path.join(OUTDIR, "RV8GR-V2.kicad_sch")
    with open(sch_path, "w") as f:
        f.write(generate_top_sch())
    print(f"✓ Created RV8GR-V2.kicad_sch")

    # Generate netlist file - THE CRITICAL DELIVERABLE
    net_path = os.path.join(OUTDIR, "RV8GR-V2.net")
    with open(net_path, "w") as f:
        f.write(generate_netlist())
    print(f"✓ Created RV8GR-V2.net")
    ...
    print(f"  - RV8GR-V2.kicad_pro   (project file)")
    print(f"  - RV8GR-V2.kicad_sch   (top-level schematic)")
    print(f"  - RV8GR-V2.net         (CRITICAL: KiCad netlist)")
    print(f"\nNext steps:")
    print(f"  1. Open RV8GR-V2.kicad_pro in KiCad 10.0+")
    print(f"  2. Import netlist: Tools → Generate Netlist → Import")
    print(f"  3. Or use: kicad-cli sch import netlist RV8GR-V2.net")
