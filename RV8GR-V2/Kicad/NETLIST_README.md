# RV8GR-V2 KiCad Netlist - Generated Files
...
|------|------|-------------|
| `RV8GR-V2.kicad_pro` | 432 bytes | KiCad project file |
| `RV8GR-V2.kicad_sch` | 13K | Top-level schematic with global labels |
| `RV8GR-V2.net` | 32K | **CRITICAL: KiCad netlist with all connections** |
...
1. Open KiCad 10.0+
2. File → Open Project → `RV8GR-V2.kicad_pro`
3. Open Schematic Editor
4. Tools → Generate Netlist → Import `RV8GR-V2.net`
...
kicad-cli sch import netlist RV8GR-V2.net

# Run ERC
kicad-cli sch erc RV8GR-V2.kicad_sch
```
