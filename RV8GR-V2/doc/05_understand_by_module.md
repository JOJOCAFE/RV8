...
**สอน CPU 33 ชิปตัวนี้ทีละขั้น ใช้ภาษาง่ายๆ ไม่รีบ อ่านจบแล้วต่อวงจรได้เลย**
...
ทั้งหมดนี้ทำได้ด้วยชิป 33 ตัว ไม่มี microcode ไม่มี lookup table.
...
CPU 33 ชิปอยู่บน breadboard — แต่ต้องต่อกับ:
...
- **สัญญาณเหมือนกัน! แค่ CPU ข้างในเป็น 33 ชิปแทน 1 ชิป**
...
>
> 0. รู้จักชิป TTL ทั้ง 33 ตัว (74HC161, 574, 245, 283, 86, 157...)
