...
XOR A-input ← IBUS (DIP switch #1 = operand):
  U12 pin 1 (1A) ← IB0 (DIP bit 0)
  U12 pin 4 (2A) ← IB1 (DIP bit 1)
  U12 pin 9 (3A) ← IB2 (DIP bit 2)
  U12 pin 12(4A) ← IB3 (DIP bit 3)
  U13 pin 1 (1A) ← IB4 (DIP bit 4)
  U13 pin 4 (2A) ← IB5 (DIP bit 5)
  U13 pin 9 (3A) ← IB6 (DIP bit 6)
  U13 pin 12(4A) ← IB7 (DIP bit 7)
