...
U32 (Data Page Register):
  ...
  D inputs ← IBUS:
    pin 2 ← IB0    pin 3 ← IB1    pin 4 ← IB2    pin 5 ← IB3
    pin 6 ← IB4    pin 7 ← IB5    pin 8 ← IB6    pin 9 ← IB7
...
| LB ได้ $00 แทน $AA | IBUS driver conflict | เช็ค BUF_OE_SAFE: U7 ต้อง disabled ตอน LB |
...
> ⚠️ **SB ไปที่ ROM address = ไม่มีผล** (ROM /WE ไม่ได้ต่อ)
