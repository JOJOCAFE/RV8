...
จาก Lab 05: U7 pin 19 (/OE) ← BUF_OE_SAFE (U25-8)   [ไม่ใช่ GND แล้ว!]
...
```bash
python3 rv8flash.py program test_full.bin --base 0x0000
```
...
| AC ได้ค่าผิด (ไม่ใช่ $AA) | ALU ผิด หรือ IBUS conflict | เช็ค BUF_OE_SAFE |
